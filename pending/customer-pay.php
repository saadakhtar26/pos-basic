<?php
$sql = 'SELECT * FROM `invoice` WHERE `chain_id`=0 AND `pending_status`=1 AND `pending`>0';
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="edit_notif.php?id=<?php echo $row["id"]; ?>" class="item" title="Edit">
                    ...
                    if (mysqli_num_rows($result3)>0) {
                        while ($row3 = mysqli_fetch_assoc($result3)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        <a href="../edit_notif.php?id=<?php echo $row3["id"]; ?>" class="item" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </div>
                                </td>
