    ...
    <div class="content mt-3 col-md-12"> 
        <div class="card">
            <div class="card-header">
                ...
                <a href="lists/add_prod.php" class="au-btn au-btn-icon au-btn--green au-btn--small" style="margin-bottom:25px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a class="item" href="lists/edit_prod.php?id=<?php echo $row['id']; ?>">
