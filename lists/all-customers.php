    ...
    <div class="content mt-3 col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="lists/add_cust.php" class="au-btn au-btn-icon au-btn--green au-btn--small" style="margin-bottom:25px;">
                ...
                <table id="bootstrap-data-table-2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                            <td><a href="purchase_history.php?id=<?php echo $row['id']; ?>"><?php echo "Rs." . $row2["purchase"]; ?></a></td>
                            <td>
                                <div class="table-data-feature">
                                    <a class="item" href="lists/edit_cust.php?id=<?php echo $row['id']; ?>">
