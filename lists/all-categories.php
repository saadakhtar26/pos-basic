    ...
    <div class="content mt-3 col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="lists/add_cat.php" class="au-btn au-btn-icon au-btn--green au-btn--small" style="margin-bottom:25px;">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a class="item" href="lists/edit_cat.php?id=<?php echo $row['id']; ?>">
                        ...
                        <tr>  
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a class="item" href="lists/edit_cat.php?id=<?php echo $row2['id']; ?>">
                                        <i class="zmdi zmdi-edit"></i>
                                    </a>
                                </div>
                            </td>
                ...
                <?php } else { echo "No Categories Available !";} ?>
            </div>
        </div>
    </div>
<!--All Categories END-->