...
<aside class="menu-sidebar d-none d-lg-block">
    <div class="logo">
        <a href="http://localhost/pos/hardware/index.php">
            Hardware
        </a>
    </div>
        ...
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                <li <?php if(strpos($_SERVER["PHP_SELF"], "lists")){echo 'class="active"';}?>>
                    <a href="http://localhost/pos/hardware/lists/index.php">
                        <i class="fas fa-table"></i>Lists</a> 
                </li>
                <li class="has-sub<?php if(strpos($_SERVER["PHP_SELF"], "invoice")){echo ' active';}?>">
                    <a class="js-arrow" href="#">
                    ...
                    <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                        <li>
                            <a href="http://localhost/pos/hardware/invoice.php">
                                <i class="fas fa-table"></i>List</a>
                        </li>
                        <li><a href="http://localhost/pos/hardware/invoice_history.php"><i class="fas fa-history"></i>History</a></li>
                    </ul>
                </li>
                <li <?php if(strpos($_SERVER["PHP_SELF"], "sale")){echo 'class="active"';}?>>
                    <a href="http://localhost/pos/hardware/1/sale.php">
                        <i class="fas fa-cart-plus"></i>Sale</a>
                </li>
                <li <?php if(strpos($_SERVER["PHP_SELF"], "notification")){echo 'class="active"';}?>>
                    <a href="http://localhost/pos/hardware/notification.php">
                ...
                <li class="has-sub<?php if(strpos($_SERVER["PHP_SELF"], "pending")){echo ' active';}?>">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="http://localhost/pos/hardware/pending/index.php?page=1">Someone Pay (Kisi ne)</a>
                        </li>
                        <li>
                            <a href="http://localhost/pos/hardware/pending/index.php?page=2">We Pay (Hum ne)</a>
                        </li>
                        <li>
                            <a href="http://localhost/pos/hardware/pending/index.php?page=3">Customer</a>
                        </li>
                    </ul>
                </li>
                <li class="<?php if(strpos($_SERVER["PHP_SELF"], "history")){echo ' active';}?>">
                    <a href="http://localhost/pos/hardware/history.php">
