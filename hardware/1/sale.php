...
<body onload="default_focus()">
  ...
  <div class="page" style="margin-left: 20px; margin-right: 20px;">
    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="http://localhost/pos/hardware/index.php">Dashboard</a></li>
...
$(".billingForm").submit(function(e) {
    ...
    $.ajax({
		...
		success: function(data){
			...
			if(data != "ERROR"){
				newWin= window.open("");
				newWin.location.replace('http://localhost/pos/hardware/view_invoice.php?id='+data);
				newWin.print();
				newWin.close();
