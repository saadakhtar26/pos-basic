                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="http://localhost/pos/ply-wood/edit_notif.php?id=<?php echo $row["id"]; ?>" class="item" title="Edit">
                    ...
                    if (mysqli_num_rows($result3)>0) {
                        while ($row3 = mysqli_fetch_assoc($result3)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        <a href="http://localhost/pos/ply-wood/edit_notif.php?id=<?php echo $row3["id"]; ?>" class="item" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </div>
                                </td>
